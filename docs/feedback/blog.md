...
|------|-------------|-----------|-------|
| 1. Collect materials throughout | Ongoing capture | In progress | Tracking in this file |
| 2. Structure outline | Draft structure | Pending | |
| 3. Write first draft | 1,500-3,000 words | Pending | |
...
*To be populated as we follow the process.*
